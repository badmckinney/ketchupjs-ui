      ...
      <>
        ...
        <div className="quick-links">
          <div className="column installation">
            <img src="" alt="install icon" className="icon" />
            <h2>Installation</h2>
            ...
            <Link to="/docs" exact={true}><button>Read installation docs</button></Link>
          </div>
          <div className="column cdn">
            <img src="" alt="install icon" className="icon" />
            <h2>KetchupCDN</h2>
            <div>When you are building a web-based application with no backend and only need to include the compiled JS, you can use KetchupCDN.</div>
            <div className="code">{'<script src=></script>'}</div>
            <Link to="/docs" exact={true}><button>Explore the docs</button></Link>
          </div>
          <div className="column feature">
            ...
            <img src="" alt="screenshot of feed page" />
            <Link to="/feed" exact={true}><button>Browse Feed</button></Link>
          </div>
        </div>
      </>
    );
