    ...
    return (
      <div className="examples">
        ...
        <div className="content">
          ...
          <div className="description">By setting <span className="bold">public</span> to false you can prevent anyone from viewing this data through our service at <a href="/">ketchupjs.dev</a> (defaulted to true, this can be changed in your profile settings).</div>
